...
part of 'user_transaction_with_fallback_and_customer_balance.dart';
...
UserTransactionWithFallbackAndCustomerBalance
    _$UserTransactionWithFallbackAndCustomerBalanceFromJson(
        ...
        UserTransactionWithFallbackAndCustomerBalance(
          ...
          campaignPointAmount:
              (json['campaign_point_amount'] as num?)?.toDouble(),
          ...
          transfers: (json['transfers'] as List<dynamic>)
              .map((e) => UserTransferWithoutAccount.fromJson(
                  e as Map<String, dynamic>))
              .toList(),
          fallbackTransactions:
              (json['fallback_transactions'] as List<dynamic>?)
                  ?.map((e) =>
                      UserTransactionWithTransfersAndCustomerBalance.fromJson(
                          e as Map<String, dynamic>))
                  .toList(),
        );

Map<String, dynamic> _$UserTransactionWithFallbackAndCustomerBalanceToJson(
        UserTransactionWithFallbackAndCustomerBalance instance) =>
    <String, dynamic>{
      'id': instance.id,
      'user': instance.user,
      ...
      'fallback_transactions': instance.fallbackTransactions,
    };
