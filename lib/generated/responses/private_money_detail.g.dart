...
part of 'private_money_detail.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PrivateMoneyDetail _$PrivateMoneyDetailFromJson(Map<String, dynamic> json) =>
    PrivateMoneyDetail(
      ...
      sounds:
          PrivateMoneySounds.fromJson(json['sounds'] as Map<String, dynamic>),
      organization:
          Organization.fromJson(json['organization'] as Map<String, dynamic>),
      maxBalance: (json['max_balance'] as num).toDouble(),
      transferLimit: (json['transfer_limit'] as num).toDouble(),
      moneyTopupTransferLimit:
          (json['money_topup_transfer_limit'] as num).toDouble(),
      ...
      topupMethods: (json['topup_methods'] as List<dynamic>)
          .map((e) =>
              PrivateMoneyTopupMethod.fromJson(e as Map<String, dynamic>))
          .toList(),
      fallbackMoneys: (json['fallback_moneys'] as List<dynamic>)
          .map((e) => FallbackPrivateMoney.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$PrivateMoneyDetailToJson(PrivateMoneyDetail instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'type': instance.type,
      ...
      'money_topup_transfer_limit': instance.moneyTopupTransferLimit,
      ...
      'fallback_moneys': instance.fallbackMoneys,
    };
