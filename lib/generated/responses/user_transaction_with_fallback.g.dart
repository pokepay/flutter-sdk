...
part of 'user_transaction_with_fallback.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UserTransactionWithFallback _$UserTransactionWithFallbackFromJson(
    ...
    UserTransactionWithFallback(
      ...
      transfers: (json['transfers'] as List<dynamic>)
          ...
          .toList(),
      fallbackTransactions: (json['fallback_transactions'] as List<dynamic>?)
          ?.map((e) =>
              UserTransactionWithTransfers.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$UserTransactionWithFallbackToJson(
        UserTransactionWithFallback instance) =>
    <String, dynamic>{
      'id': instance.id,
      'user': instance.user,
