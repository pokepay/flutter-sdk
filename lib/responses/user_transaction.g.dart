...
UserTransaction _$UserTransactionFromJson(Map<String, dynamic> json) => UserTransaction(
      ...
      transfers:
          (json['transfers'] as List<dynamic>?)?.map((e) => UserTransfer.fromJson(e as Map<String, dynamic>)).toList(),
    );
