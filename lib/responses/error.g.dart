...
APIRequestError _$APIRequestErrorFromJson(Map<String, dynamic> json) => APIRequestError(
...
ProcessingError _$ProcessingErrorFromJson(Map<String, dynamic> json) => ProcessingError(
      message: json['message'] as String,
    );
...
OAuthRequestError _$OAuthRequestErrorFromJson(Map<String, dynamic> json) => OAuthRequestError(
      statusCode: json['status_code'] as int,
